...
export const metadata: Metadata = {
  title: "AgentKit External Wallet",
  description: "AgentKit with external wallet integration - Your keys, your crypto",
};

/**
 * Root layout for the page with wallet connection support
 *
  ...
  return (
    <html lang="en">
      <body className="bg-gray-100 dark:bg-gray-900 dark flex flex-col min-h-screen">
        <WagmiProvider>
          {/* Header (Fixed Height) */}
          <header className="py-6 flex items-center justify-between relative px-4">
            <img
